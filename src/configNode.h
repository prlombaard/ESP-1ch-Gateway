...
//
codex decodes[] = {
	{ 0x26011A2A , "RP2040", 	// F=0
		{ 0xFC, 0xA9, 0x01, 0xA8, 0xCF, 0xFD, 0xE4, 0x03, 0xA9, 0x43, 0x4E, 0x03, 0x57, 0x9D, 0x96, 0x8A },
		{ 0x81, 0x7E, 0x57, 0x71, 0x33, 0xD6, 0x62, 0x38, 0x96, 0x6F, 0x20, 0x50, 0x81, 0x2B, 0x63, 0xB1 } 
	},
...
#define _EMAIL "prlombaard@gmail.com"		// Owner
#define _PLATFORM "ESP32"
#define _LAT -25.993
#define _LON 28.1582
#define _ALT 1200								// Altitude
